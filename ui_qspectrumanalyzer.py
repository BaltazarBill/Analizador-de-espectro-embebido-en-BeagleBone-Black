 ...
 * Este módulo contiene la definición de la interfaz gráfica de usuario (GUI) para el analizador de espectro.
 * El código ha sido generado automáticamente a partir de un archivo .ui (Qt Designer) y define la disposición
 * de widgets, layouts, menús y paneles acoplables (Docks).
 *
 * Funcionamiento general:
 * - La clase Ui_QSpectrumAnalyzerMainWindow actúa como una "fábrica" de interfaz.
 * - El método setupUi construye el árbol de widgets: Ventana principal -> Widget central -> Splitter -> Gráficos.
 * - Se integran widgets personalizados de PyQtGraph (GraphicsLayoutWidget) para la visualización de señales.
 * - Se configuran paneles laterales (Docks) para controles de frecuencia, ajustes y niveles.
 *
 * Notas importantes:
 * - Este archivo no debe modificarse manualmente si se planea regenerar desde Qt Designer.
 * - Utiliza el wrapper 'Qt' para abstracción entre versiones de librerías (PySide/PyQt).
 * ****************************************************************************************************************************/
...
class Ui_QSpectrumAnalyzerMainWindow(object):
    """
    Clase que define la estructura visual de la Ventana Principal del Analizador.
    No contiene lógica de negocio, solo definición de componentes gráficos.
    """

    # //===================================================================================================
    # //================================ CONFIGURACIÓN DE LA UI (SETUP) ===================================
    # //===================================================================================================

    def setupUi(self, QSpectrumAnalyzerMainWindow):
        """
        Inicializa y configura todos los widgets de la ventana principal.
        
        Variables utilizadas:
            - QSpectrumAnalyzerMainWindow: Instancia de QMainWindow donde se "pintará" la interfaz.
            - centralwidget: Contenedor principal.
            - plotSplitter: Divisor redimensionable para los gráficos.
            - DockWidgets: Paneles laterales flotantes/acoplables.
        
        Funcionamiento:
            1. Configura propiedades básicas de la ventana (tamaño, nombre).
            2. Crea el widget central y su layout.
            3. Instancia los widgets de gráficos (Main Plot y Waterfall).
            4. Configura la barra de menús y la barra de estado.
            5. Crea y puebla los Docks (Controles, Frecuencia, Configuración, Niveles).
            6. Establece el orden de tabulación y conecta slots automáticos.
        """
        ...
        # --- Configuración del Splitter (Divisor de gráficos) ---
        # Permite al usuario redimensionar el área entre el espectro y la cascada (waterfall)
        ...
        # --- Gráfico Principal (Espectro 2D) ---
        # Se utiliza GraphicsLayoutWidget de la librería externa PyQtGraph
        ...
        # --- Gráfico de Cascada (Waterfall - Tiempo/Frecuencia) ---
        ...
        # //===================================================================================================
        # //=========================== PANELES ACOPLABLES (DOCK WIDGETS) =====================================
        # //===================================================================================================

        # --- Dock 1: Controles de Flujo (Start/Stop) ---
        ...
        # Permite que el dock flote o se mueva
        ...
        # --- Dock 2: Configuración de Frecuencia ---
        ...
        # Campos de frecuencia (Start, Stop, Bin Size)
        ...
        # --- Dock 3: Ajustes Generales (Settings) ---
        ...
        # Etiquetas y SpinBoxes de Configuración (Intervalo, Ganancia, PPM)
        ...
        # Checkboxes y Botones de Visualización (Curvas, Colores, Suavizado)
        ...
        # Widget para el histograma de niveles
        ...
        # --- Configuración de Atajos y Tabulación ---
    ...
    # //===================================================================================================
    # //============================ TRADUCCIÓN DE INTERFAZ (I18N) ========================================
    # //===================================================================================================

    def retranslateUi(self, QSpectrumAnalyzerMainWindow):
        """
        Establece los textos visibles de la interfaz (títulos, etiquetas, botones).
        Permite la internacionalización mediante Qt Linguist.
        
        Variables:
            - QSpectrumAnalyzerMainWindow: La ventana principal a traducir.
        """
        _translate = QtCore.QCoreApplication.translate
        QSpectrumAnalyzerMainWindow.setWindowTitle(_translate("QSpectrumAnalyzerMainWindow", "Analizador de espectro - Medidas Electrónicas II"))
...
# Importación necesaria para que Qt Designer reconozca el widget personalizado 'GraphicsLayoutWidget'.
# Se coloca al final para evitar problemas de dependencias circulares en algunas configuraciones generadas.
